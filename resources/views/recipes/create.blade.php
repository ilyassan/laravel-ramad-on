...
<head>
    ...
    <title>Ajouter une nouvelle recette - Ramadan 2025</title>
...
<body class="font-sans bg-gray-50">
    ...
    <section class="pt-24 pb-12 md:pt-32 md:pb-24 bg-gradient-to-r from-purple-50 to-purple-100">
        <div class="container mx-auto px-4 md:px-6 lg:px-8">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 text-center mb-8">Ajouter une nouvelle recette</h1>
            <div class="max-w-3xl mx-auto bg-white rounded-xl shadow-md overflow-hidden">
                <form id="addRecipeForm" class="p-6 md:p-8">
                    <div class="mb-6">
                    ...
                    <div class="mb-6">
                        <label for="title" class="block text-gray-700 text-sm font-bold mb-2">Titre de la recette</label>
                    ...
                    <div class="mb-6">
                        ...
                        <select id="category" name="category" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500" required>
                    ...
                    <div class="mb-6 grid grid-cols-2 gap-4">
                        <div>
                            <label for="prepTime" class="block text-gray-700 text-sm font-bold mb-2">Temps de préparation (minutes)</label>
                            <input type="number" id="prepTime" name="prepTime" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500" required>
                        </div>
                        <div>
                            <label for="servings" class="block text-gray-700 text-sm font-bold mb-2">Nombre de personnes</label>
                            <input type="number" id="servings" name="servings" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500" required>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            addRecipeForm.addEventListener('submit', function(event) {
                ...
                console.log('Preparation Time:', formData.get('prepTime'));
                console.log('Servings:', formData.get('servings'));
