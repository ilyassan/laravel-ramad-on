                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                            ...
                            <div class="mt-4 md:mt-0 flex items-center space-x-4">
                                <img class="h-12 w-12 rounded-full border-2 border-purple-100" 
                                     ...
                                     alt="Author">
                                <div>
                                    <p class="text-base font-semibold text-gray-900">{{ $experience->user->getName() }}</p>
                                    <p class="text-sm text-gray-500">{{ \Carbon\Carbon::parse($experience->created_at)->diffForHumans() }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-6">
                                <button class="flex items-center space-x-2 text-gray-600 hover:text-purple-600 transition-colors">
                                    ...
                                    <span class="font-medium">{{ count($experience->comments) }} Commentaires</span>
                                </button>
                            </div>
